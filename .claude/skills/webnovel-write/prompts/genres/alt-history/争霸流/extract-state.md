<!-- generated slot=extract_state gen_hash=106c8aef26 -->
...
```json
{
  "new_characters": [
    {
      ...
      "identity": "身份（朝臣/武将/幕僚/世家子/商贾/流民首领等）",
      "relation": "与主角关系",
      "appearance": "外貌描写",
      "personality": "性格特点",
      "realm": "当前官职或地位（如从七品县丞、游击将军、侯府世子）",
      "location": "当前地点（如京城东市、雁门关、江南道）",
      "first_action": "本章主要行为"
    }
  ],
  "new_treasures": [
  ...
  "status_changes": [
    {
      ...
      "realm": "最新官职/地位（未变化填空字符串）",
      "location": "最新地点（未变化填空字符串）",
      "change": "状态变化简述（如升官晋爵、贬官流放、重伤、身份败露）"
    }
  ],
  "entity_events": [
  ...
  "status_file_updates": {
    ...
    "resource_updates": [
      {"resource_name": "资源名（如白银、粮草、兵员、田亩、气运）", "new_value": "新值", "reason": "变化原因"}
    ],
    "troop_casualties": {
      "dead_count": "死亡人数（数字或估算如'约500人'）",
      "wounded_count": "受伤人数",
      "surviving_count": "存活人数（如果正文提到）",
      "unit_name": "部队名称（如'前锋营'、'夜不收'、'家丁队'等）",
      "description": "伤亡描述"
    },
    "new_items": [
...
⚠️ **命名统一规则（必须遵守）**：
1. 若正文提到的武艺/技艺与【当前已有武艺/技艺】显然是同一招式（简称/别称/口语化写法），不要在 `new_techniques` 新建重复档案。

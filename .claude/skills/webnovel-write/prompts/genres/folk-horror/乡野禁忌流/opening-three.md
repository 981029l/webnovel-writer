<!-- generated slot=opening_three gen_hash=0bfc0df54e -->
...
【三章功能分配】
- 第 1 章：立住主角（处境+性格+第一动作），亮出金手指或核心优势的第一面；前 300 字内必须出现钩子与情绪锚点，并给出「代偿承诺」——让读者预感到眼下的憋屈会翻倍偿还。（如：第一场白事就撞上不干净的主家，师父留下的三条规矩救了主角一命。）

<!-- generated slot=opening_three gen_hash=e6588d7729 -->
...
【三章功能分配】
- 第 1 章：立住主角（处境+性格+第一动作），亮出金手指或核心优势的第一面；前 300 字内必须出现钩子与情绪锚点，并给出「代偿承诺」——让读者预感到眼下的憋屈会翻倍偿还。（如：婚礼/葬礼/产房门口的背叛现场直击，女主当场立下反击的第一步。）
